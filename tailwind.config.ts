...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        'primary-1': 'var(--shadow-primary-1)',
        'primary-2': 'var(--shadow-primary-2)',
        'primary-3': 'var(--shadow-primary-3)',
        'primary-4': 'var(--shadow-primary-4)',
        'secondary-1': 'var(--shadow-secondary-1)',
        'secondary-2': 'var(--shadow-secondary-2)',
        'secondary-3': 'var(--shadow-secondary-3)',
        'secondary-4': 'var(--shadow-secondary-4)',
      },
    },
  },
